...
public class PropertiesToBeanConverter implements RequestConverter {
   ...
   * @throws InstantiationException could not initialize instance of bean
   * object.
   * @throws WrongProperyIndex
   * @throws MissingArgumentException One or more bean properties (annotated
   * with the MandatoryProperty annotation has not been found in the properties
   * map.
   */

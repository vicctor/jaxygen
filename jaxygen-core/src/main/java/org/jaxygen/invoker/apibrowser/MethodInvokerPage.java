...
public class MethodInvokerPage extends Page {
 ...
 public MethodInvokerPage(ClassRegistry registry, ServletContext context,
         HttpServletRequest request, final String classFilter, final String methodFilter) throws NamingException, IllegalArgumentException, SecurityException, InstantiationException, IllegalAccessException, InvocationTargetException, NoSuchMethodException, ClassNotFoundException, IOException {
  ...
  renderClassForm(request, classFilter, methodFilter);
 }
 ...
 private void renderClassForm(HttpServletRequest request, final String classFilter, final String methodFilter)
  ...
  System.out.println("Browsing for filter: " + methodFilter);
 ...
 /**
  * Add list of parameters from bean class passed in the parameter paramClass as
  * a list of rows to the table.
  *
  * @param request
  * @param table
  * @param paramClass
